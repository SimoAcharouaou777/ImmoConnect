...
<div class="flex flex-col items-center gap-16">
    ...
    <div>
        <button type="button" class="text-white bgColor2 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Browse More Properties</button>
    </div>
    
</div>

</section>
</section class="bgColor1 py-8">
    <div class="flex flex-col items-center gap-16">
