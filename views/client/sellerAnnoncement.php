...
<div class="p-4 sm:ml-64 ">
   <div class="p-16 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
        ...
        <!-- Modal toggle -->
        <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" class=" mb-6 lock text-white bgColor2 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
        Create annoncement
        </button>
