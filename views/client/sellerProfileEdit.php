<?php
 ...
 require '../../views/partials/sellerProfile.php';
//  include '../../views/partials/sellerProfile.php';
...
//  $user = $authController->showUserByEmail();
        ...
        <div class="w-full m-auto max-w-md bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ">
                    <div class="flex flex-col items-center  pb-10">
                        ...
                        <form class="flex flex-col justify-center max-w-md mx-auto" method ="POST" action="user/updtae/profile">
                            ...
                            <div class="grid md:grid-cols-2 md:gap-6">
                                <div class="relative z-0 w-full mb-5 group">
                                    <input type="hidden" name="emailHiden" id="emailHiden" value="<?php echo $user['email']; ?>" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
